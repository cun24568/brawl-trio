  ...
  el.innerHTML = `
    <div class="bg-gray-800 rounded overflow-hidden">
      ...
      <div class="p-6">
        ...
        <div class="text-xs text-gray-500 mt-1">スコア: 1位+9 / 2位+4 / 3位-4 / 4位-9。高トロ帯(2000+)バトル2倍。使用率TOP3で1.02倍、ピック率5%以上 かつ WR>マップ平均で1.05倍。300戦以下は0.9倍。ベイズ平均化。50戦以上でpercentileティア</div>
        ${filterButtons}
